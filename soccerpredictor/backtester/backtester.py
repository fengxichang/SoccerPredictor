    ...
    for dataset in datasets:
        ...
        for team in dfs[dataset].columns.get_level_values("team").unique():
            ...
            for i, r in df_subset.iterrows():
                ...
                if opponent_row["match_id"].iloc[0] in processed_matches_ids:
                    continue
                elif dataset == Dataset.Predict.value and opponent_row["match_id"].iloc[0] in predict_set_processed_ids:
                    continue
